...
fun ProfileForm(
    ...
    Column(
        ...
        CustomTextField(
            ...
            error = firstName.length !in 3..50 // Nomes com menos de 3 caracteres
        )
        CustomTextField(
            value = lastName,
        ...
        CustomTextField(
            value = city ?: "", // ser city não for nulo, o valor usado será de city. Se for nulo será vazio
            onValueChange = onCityChange,
            placeholder = "City",
            error = city?.length !in 3..50
        )
        CustomTextField(
            value = "${postalCode ?: ""}", // postalCode ou se for null, vai ser branco
            onValueChange = { onPostalCodeChange(it.toIntOrNull()) }, // converter para um string->int
        ...
        Row( // [Dial Code] + [Phone Number]
            ...
            ) // quando aperta nele abre o Dialog (Dial Code)
